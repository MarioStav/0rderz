...
public class DBConnect {
    ...
    public void insert_b(int TischNr, int SVNr, String Zeit, String Essen, String Getraenk, double Preis) {
    ...
    public void delete_b(int TischNr, int SVNr) {

        String url = "jdbc:sqlite:C:/Users/Christoph/Schule/POS_3CHIF/POS-Project/G2B-Database/G2B.db";
        String sql = "DELETE FROM Bestellung WHERE TischNr = ? AND SVNr = ?";
