    ...
    public static void loginConfirm(JButton button_login, JTextField svnr_field, JPasswordField pw_field, JFrame login, JLabel name) {
        ...
        button_login.addActionListener(action -> {
            ...
            */
            ...
            File sound_error = new File("C:\\Users\\Christoph\\IdeaProjects\\G2B\\src\\Sounds\\Error.wav");
            File sound_tromp = new File("C:\\Users\\Christoph\\IdeaProjects\\G2B\\src\\Sounds\\SadTrompete.wav");
